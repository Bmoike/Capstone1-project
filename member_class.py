...
class Single(Members):
    ...
    def check_in(self, club_assigned):
        club_name = club_assigned
        while True:
            ...
            if club_name == 'Cancel':
                ...
                print(f"This is not your assigned club. Your assigned club is {self.club.name}.")
                club_name = input("Please enter your club or, if you don't want to check in, please input Cancel: ").title()
...
def main():
    ...
    while True:
        ...
        if choice == "1":
            ...
            name = input("Enter Member Name: ").title()
